...
let cardConstructor = (array) => {
  return `<img class="w-[220px] lg:w-[120px] xl:w-[250px] image-cover rounded-lg self-center border border-purple-800" src="${
    array.image
  }" alt="">
    <h3 class="font-semibold text-base">${array.title}</h3>
    <p class="font-lg">${array.tagline}</p>
    <p class="text-justify text-sm">${array.overview.slice(
      0,
      160
